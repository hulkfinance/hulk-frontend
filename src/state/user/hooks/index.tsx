...
import { ChainId, Pair, Token } from '@hulkfinance/hulk-swap-sdk'
...
export function useGasPrice(): string {
  ...
  return chainId.toString() === ChainId.MAINNET.toString() ? userGas : GAS_PRICE_GWEI.testnet
}
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Hulk-LP', 'Pancake LPs')
}
